...
def send_atm_brief_published_email(brief):
    from app.api.services import (
        audit_service,
        audit_types,
        domain_service,
...
def send_training2_brief_published_email(brief):
    from app.api.services import (
        audit_service,
        audit_types,
        domain_service,
    ...
    brief_email_sent_audit_event = audit_service.find(type=audit_types.training2_brief_published.value,
                                                      object_type="Brief",
                                                      object_id=brief.id).count()
    ...
    audit_service.log_audit_event(
        audit_type=audit_types.training2_brief_published,
        user='',
        data={
            "to_addresses": ', '.join(to_addresses),
            "email_body": email_body,
